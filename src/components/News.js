...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=9122f1b0c8154195ad9ff43bc0e9be79&page=${this.state.page}&pageSize=${this.props.pageSize}`;
